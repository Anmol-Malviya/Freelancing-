...
export const HeroSection: React.FC = () => {
    ...
    const backgroundY = useTransform(smoothScrollY, [0, 1000], [0, 400]);
    const planetY = useTransform(smoothScrollY, [0, 1000], [0, 150]);
    ...
    return (
        <div className="relative w-full bg-black text-white overflow-hidden">
            ...
            <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 h-screen">
                ...
                >            <ElasticHueSlider
                    ...
                    <motion.div
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="flex items-center space-x-2 px-4 py-2 bg-brand-500/10 border border-brand-500/30 text-brand-400 hover:bg-brand-500/20 backdrop-blur-sm rounded-full text-sm mb-6 transition-all duration-300 group"
                    >
                        <span className="font-semibold">The Next-Gen Developer Marketplace</span>
                    </motion.div>
                    ...
                    <motion.h2
                        variants={itemVariants}
                        className="text-3xl md:text-5xl pb-3 font-bold bg-gradient-to-r from-brand-400 via-purple-400 to-brand-300 bg-clip-text text-transparent"
                    >
                        Monetize Your Code & Creativity
                    </motion.h2>
                    ...
                    <motion.a
                        ...
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        className="mt-[40px] px-10 py-4 bg-brand-600 font-bold text-white shadow-[0_0_30px_rgba(97,114,243,0.3)] hover:shadow-[0_0_40px_rgba(97,114,243,0.5)] backdrop-blur-sm rounded-full transition-all"
                    >
                        Start Exploring
                    </motion.a>
                </motion.div>
            ...
            >
                ...
                <motion.div
                    style={{ y: planetY, x: "-50%" }}
                    className="absolute top-[65%] left-1/2 w-[800px] h-[800px] rounded-full bg-brand-500/10 blur-[80px]"
                ></motion.div>

                {/* Central light beam - now using the state variable for hue */}
                <div className="absolute top-0 w-[100%] left-1/2 transform -translate-x-1/2 h-full opacity-80">
                    <Lightning
                ...
                <motion.div
                    style={{ y: planetY, x: "-50%" }}
                    className="z-10 absolute top-[65%] left-1/2 w-[800px] h-[800px] rounded-full bg-[radial-gradient(circle_at_50%_0%,_rgba(15,23,42,0.9)_0%,_#000000_40%,_#000000_100%)] shadow-[inset_0_2px_20px_rgba(97,114,243,0.3),0_-10px_40px_rgba(97,114,243,0.15)] border-t border-brand-400/40"
                ></motion.div>
            </motion.div>
        </div>
    );
